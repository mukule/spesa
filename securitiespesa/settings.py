"""
Django settings for securitiespesa project.
...
SECRET_KEY = 'django-insecure-f+b0d&u4mpr0z0z*zaybia#mfb1!w%_=g4ljb^)tx&#s5v9c%x'
...
ROOT_URLCONF = 'securitiespesa.urls'
...
WSGI_APPLICATION = 'securitiespesa.wsgi.application'
